...
class ModeloTelaAdministrador(QMainWindow):
    def __init__(self):
        ...
        self.btn_calendario = btn_layout(
            os.path.join(BASE, "Imagens/Calendario-Icone.png"),
            "Calendário"
        )
        ...
        self.btn_validadores = btn_layout(
            os.path.join(BASE, "Imagens/Validadores-Icone.png"),
            "Validadores"
        )
        ...
        self.texto_email = QLabel(
            card_popup
        )

        self.texto_email.setGeometry(
            20,
            205,
            300,
            50
        ...
        self.texto_funcao = QLabel(
            card_popup
        )

        self.texto_funcao.setGeometry(
            20,
            417,
            210,
            50
        ...
        self.checkbox_pesquisador = QCheckBox(
            "Pesquisador",
            card_popup
        )

        self.checkbox_pesquisador.setGeometry(
            290,
            395,
            200,
            100
        ...
        self.dropdown_validador = QComboBox(
            card_popup
        )
        ...
        self.dropdown_validador.setPlaceholderText(
            "Validadores"
        )

        self.dropdown_validador.setGeometry(
            570,
            417,
            220,
            45
        ...
        self.checkbox_comite = QCheckBox(
            "Comitê",
            card_popup
        )

        self.checkbox_comite.setGeometry(
            910,
            395,
            200,
            100
        ...
        self.checkbox_administrador = QCheckBox(
            "Administrador",
            card_popup
        )

        self.checkbox_administrador.setGeometry(
            1190,
            395,
            200,
            100
        ...
        self.botao_cadastrar.setGeometry(
            706,
            545,
            690,
            67
