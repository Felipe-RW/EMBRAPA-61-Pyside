...
class ModeloTelaAdministrador(QMainWindow):
    def __init__(self):
        ...
        titulo = QLabel("Cadastrar Empregado", paginaprincipal)
        titulo.setAlignment(Qt.AlignCenter)
        titulo.setGeometry(400, 40, 700, 60)
        ...
        self.botao_cadastrar = QPushButton("Cadastrar", card_popup)
        self.botao_cadastrar.setGeometry(830, 545, 563, 67)
