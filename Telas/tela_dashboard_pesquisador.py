...
class GraficoDonut(QMainWindow):
    def __init__(self):
        ...
        fatia1 = series.append("Aprovadas<br>15 (42%)", 50)
        ...
        fatia2 = series.append("Em análise<br>15 (42%)", 25)
        ...
        fatia3 = series.append("Negadas<br>5 (15%)", 25)
